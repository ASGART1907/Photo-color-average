...
const App = () => {
  ...
  return (
    <div className='container' style={{backgroundColor:`rgba(${color})`}}>
      <div className='wrapper'>
        <span className="btn-add">+</span>
         <input type="file" className='file' onChange={changeFile} ref={fileRef} />
      </div>
